...
def prepare(repo, manifest_path, output_dir):
    ...
    status = run_root(
        repo / "plotER/Validation/macros/PreparePbPbPsi2SXeff30Cache.C",
...
def splot(repo, manifest_path, output_dir):
    ...
    status = run_root(
        repo / "plotER/Validation/macros/PbPbPsi2SNominalSPlot.C",
...
def analyze(repo, manifest_path, output_dir, variable, input_dir=None,
    ...
    status = run_root(
        repo / "plotER/Validation/macros/AnalyzePbPbPsi2SVariable.C",
