...
MACRO="${SCRIPT_DIR}/macros/PlotPbPb24Psi2SSelectionMassScan.C"
...

{
  ...
  echo "command=root -l -b -q macros/PlotPbPb24Psi2SSelectionMassScan.C"
} > "${OUTPUT}/run_metadata.txt"

cd "${SCRIPT_DIR}"
root -l -b -q 'macros/PlotPbPb24Psi2SSelectionMassScan.C()' \
