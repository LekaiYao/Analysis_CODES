...
def prepare(repo, manifest_path, manifest, output_dir):
    ...
    status = run_root(repo / "fitER/cache/PrepareXFitScanCache.C", expression,
...
def fit_point(repo, manifest_path, manifest, output_dir, key):
    ...
    if manifest["contract"] == DATA_ONLY_CONTRACT:
        ...
        source_macro = repo / "fitER/models/PbPbXDataGaussianFit.C"
        ...
        source_macro = repo / "fitER/models/PbPbXEfficiencyFit.C"
